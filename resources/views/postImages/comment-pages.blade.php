...
@section('content')
    <div class="top-container">
        <div class="search-container">
            <p class="heading-title shadow rounded">Articles</p>
            <div class="heading shadow rounded">
                <div class="inner-heading">
                    <h4 id="display">{{$imagePost->user[0]->name}}'s Article</h4>
                    ...
                    <div class="outer-word-display shadow rounded">
                        ...
                        <div class="anchor-def">
                            <div class="search-cover">
                                <img src="{{$imagePost->update_image}}" alt="">
                            </div>
                                ...
                                @if(Auth::check())
                                    <div class="outer-comment">
                                        ...
                                        <div class="input-section">
                                            <form action="{{action('PostImageController@inputComment')}}"
                                                  method="POST"
                                                  class="comment-form">
                                                ...
                                                <div class="post_id d-none">{{$imagePost->id}}</div>
